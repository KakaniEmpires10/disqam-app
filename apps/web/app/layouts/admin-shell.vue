...
const pageTitle = computed(() => typeof route.meta.title === 'string' ? route.meta.title : 'Admin DISQAM')
const pageDescription = computed(() => typeof route.meta.description === 'string'
  ? route.meta.description
  : 'Panel monitoring penelitian DISQAM.')

useHead(() => ({
  title: `${pageTitle.value} | DISQAM`,
...
const mainItems: NavigationMenuItem[] = [
  ...
  { label: 'Sleep Diary', icon: 'i-lucide-book-heart', to: '/admin/diary' },
...
<template>
  <UTheme :ui="{ card: { root: 'bg-elevated' } }">
    <div
